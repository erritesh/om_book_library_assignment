                 ...
                 <%
                            String uId = request.getParameter("userId");
                                        ...
                                        try {
                                           con = DBUtil.getConnection();
                                            String query = "select FIRSTNAME,LASTNAME,USERNAME,EMAILID,MEMBERSHIP_TYPE,FLAG from REGISTRED_USER where USER_ID='"+uId+"'";
											...
											membershipType = rst.getString(5);
                            ...
                            <!--  Boot -->
                             ...
                             <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="txtFirstName" readonly  value="<%=firstName%>"/>
                                        </div>
                             
                               <div class="form-group">
                                            <label>Last Name :</label>
                                            <input class="form-control" type="text" name="txtLastName" readonly  value="<%=lastName%>"/>
                                        </div>  
                              
                                <div class="form-group">
                                            <label>Username :</label>
                                            <input class="form-control" type="text" name="txtUsername" readonly  value="<%=username%>"/>
                                        </div>          
                      ...
                      <div class="col-lg-4">
						<div class="form-group">
							<label>Email ID :</label> <input type="text" class="form-control"
								name="txtEmailId" readonly value="<%=emailId%>" />
						</div>
						<div class="form-group">
							<label>Membership Type :</label> <input class="form-control"
								type="text" readonly name="txtMembershipType" value="<%=membershipType%>" />
						</div>
						<div class="form-group">
							<label>Status :</label> <input class="form-control"
								type="text" readonly name="txtStatus" value="<%=status%>" />
						</div>
						<%
							}
							} catch (Exception e) {
