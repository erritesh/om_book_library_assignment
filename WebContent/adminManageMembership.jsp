...
<body>
 ...
 <i class="fa  fa-pencil"></i>&nbsp;For delete  Click on User ID.
                    </div>
                    </div>
                    <!-- code here  -->
				...
				<%
					...
					try {
						...
						String query = "select USER_ID,FIRSTNAME,LASTNAME,USERNAME,EMAILID,MEMBERSHIP_TYPE,FLAG from REGISTRED_USER";
				...
				<table id="example" class="display" cellspacing="0" width="100%">
					...
					<%
						while (rst.next()) {
							...
							membershipType = rst.getString(6);
							flag =rst.getString(7);
				%>
					<tbody>
						<tr>
							<td><a href="adminManageMembershipFinal.jsp?userId=<%=uId%>"><%=uId%></a></td>
							<td><%=firstName%></td>
							<td><%=lastName%></td>
							<td><%=username%></td>
							<td><%=emailId%></td>
